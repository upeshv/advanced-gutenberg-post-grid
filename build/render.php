...
$order_by      = isset( $attributes['orderBy'] ) && in_array( $attributes['orderBy'], array( 'date', 'title', 'menu_order', 'rand' ), true ) ? $attributes['orderBy'] : 'date';
...
$query_args = array(
	...
	'update_post_meta_cache' => $display_image, // Only cache meta if displaying thumbnails.
